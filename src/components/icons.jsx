...
export const Icon = {
  ...
  folderOpen: () => (
    <Svg>
      <path {...P} d="M2 11.6V4.4A1.4 1.4 0 0 1 3.4 3h2.7l1.4 1.5h4.1A1.4 1.4 0 0 1 13 5.9v.6" />
      <path {...P} d="M2 11.6 3.6 7.2a1 1 0 0 1 .95-.7h9.05a1 1 0 0 1 .95 1.32l-1.28 3.86a1 1 0 0 1-.95.72H3.4A1.4 1.4 0 0 1 2 11.6z" />
    </Svg>
  ),
  tokens: () => (
    <Svg>
